  ...
  return (
    <div className="bg-sestra-cream min-h-screen">
      ...
      <section className="relative grid grid-cols-1 lg:grid-cols-2 min-h-[90vh] border-b border-sestra-teal/5 lg:pt-24 pt-32">
        ...
        <div className="bg-sestra-teal text-sestra-cream flex flex-col justify-center px-6 md:px-12 lg:px-20 py-24 lg:py-32 relative">
          <div className="max-w-xl self-end space-y-12">
            <div className="space-y-6">
              ...
              <h1 className="text-6xl md:text-8xl lg:text-[100px] font-serif leading-[0.95] tracking-[-0.02em]">
            ...
            <div className="flex gap-8 items-start pl-8 border-l border-sestra-gold/20">
               <p className="text-xl md:text-2xl font-light italic leading-relaxed opacity-80 max-w-sm">
                 A high-depth strategy session for the founder who has outgrown their current visuals.
               </p>
            </div>
          </div>
        ...
        <div className="bg-sestra-cream flex flex-col justify-center px-6 md:px-12 lg:px-20 py-24 lg:py-32">
          <div className="max-w-md space-y-12">
            <div className="space-y-6">
               <span className="text-[10px] uppercase tracking-widest text-sestra-teal/40 font-light">THE SESSION DETAILS</span>
               <ul className="space-y-6">
                  {[
                    ...
                    <li key={i} className="flex justify-between items-center text-[10px] uppercase tracking-wider pb-6 border-b border-sestra-teal/5">
            ...
            <div className="pt-6">
               <Link href="/contact" className="btn-premium w-full text-center py-6">Inquire for Partnership</Link>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Main Page Content */}
      <div className="editorial-container section-padding space-y-48">
        ...
        <section className="space-y-24">
           ...
           <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
              {[
                ...
                <div key={i} className="p-12 border border-sestra-teal/5 bg-white/30 space-y-8 hover:bg-white transition-all duration-500">
           ...
           <div className="pt-12 text-center">
              <p className="text-[10px] uppercase tracking-[0.3em] text-sestra-teal/30 font-light italic">
        ...
        <section className="space-y-24">
           <header className="text-center space-y-6">
             ...
             <h2 className="text-5xl md:text-8xl text-sestra-teal font-serif">From Audit <span className="serif-italic">to Action</span></h2>
           </header>

           <div className="grid grid-cols-1 md:grid-cols-4 gap-1px bg-sestra-teal/5 border border-sestra-teal/5">
              {methodology.map((step, i) => (
                <div key={i} className="bg-sestra-cream p-12 space-y-8 hover:bg-white transition-all duration-500">
                  <span className="text-[10px] uppercase tracking-widest text-sestra-gold font-light">{step.id}</span>
                  <h4 className="text-2xl text-sestra-teal font-serif lowercase italic">{step.title}</h4>
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
           <div className="relative aspect-[4/5] bg-sestra-teal/5 overflow-hidden">
              <Image 
           ...
           <div className="space-y-16">
              ...
              <ul className="space-y-6">
                 {deliverables.map((item, i) => (
                   <li key={i} className="flex items-center gap-6 text-[10px] uppercase tracking-[0.2em] font-light text-foreground/50 pb-6 border-b border-sestra-teal/5">
        ...
        <section className="text-center space-y-16 py-32 border-t border-sestra-teal/5">
           <div className="space-y-8">
             <h2 className="text-6xl md:text-8xl lg:text-[100px] text-sestra-teal font-serif leading-[0.95] tracking-[-0.02em]">
               Ready to stop <br /> being <span className="serif-italic">bland?</span>
             </h2>
           ...
           <div className="pt-8">
              <Link href="/contact" className="btn-premium px-16 py-6 text-base">Book Your Session</Link>
           </div>
